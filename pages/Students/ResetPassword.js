...
export default function ResetPassword() {
  ...
  return (
    <div className="flex flex-col justify-center items-center h-screen w-full bg-[#e6e6e6] dark:bg-[#02201D]" >
      <h1 className="text-black dark:text-white text-xl lg:text-4xl font-bold text-center italic my-5">Reset Password</h1>
        ...
        <div className="flex flex-col">
          <div className="relative mx-5 mb-10">
            ...
            <label 
                ...
                className="absolute text-sm lg:text-xl text-black dark:text-white duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-[#e6e6e6] dark:bg-[#02201D] px-2 peer-focus:px-2 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 left-1"
            >
                New Password
            </label>
          </div>
