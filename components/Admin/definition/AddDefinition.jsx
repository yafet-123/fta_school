...
export function AddDefinition({ subjects, onAdded }) {
  ...
  const handleSubmit = async (e) => {
    ...
    setMsg('');
    try {
      const res = await fetch('/api/definition/add', {
        method: 'POST',
  ...
  return (
    <div className="bg-white rounded-xl shadow p-6 mb-6">
      <h2 className="text-xl font-bold mb-4 text-gray-800">Add Definition</h2>
